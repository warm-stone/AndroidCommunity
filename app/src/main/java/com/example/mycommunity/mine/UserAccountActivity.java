...
public class UserAccountActivity extends AppCompatActivity {
    ...
    public static final int AVATAR = 45;
        ...
        public boolean handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    UserAccountActivity.this.setResult(RESULT_OK, intent);
                    break;
                case 1:
        ...
        switch (requestCode) {
            case AVATAR:
                if (resultCode == RESULT_OK) {
                    setResult(RESULT_OK);
                    if (data != null)
                        userInformation = (UserInformation) data.getSerializableExtra("userInformation");
                }
        }
    }
}
